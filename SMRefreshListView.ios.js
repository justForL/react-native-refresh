...
import {SMRefreshScrollView,RefreshStatus,RefreshTitle} from './SMRefreshScrollView'
/**
 *===============================================SMRefreshListView=====================================
 */
/**
...
export class SMRefreshListView extends ListView{
  _isLoading = false;
  // 构造
  constructor(props) {
    super(props);
  ...
  render(){
    return(
      <ListView
        ...
        renderScrollComponent={(props) => <SMRefreshScrollView onRefresh={this.props.onRefresh} ref={(scrollView)=>{
          if (scrollView){
